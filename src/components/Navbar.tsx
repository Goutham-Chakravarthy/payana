...
import { Plus, Users, Share2, Check, Eye } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const currentParticipant = viewingUserId
    ? getParticipant(viewingUserId)
    : null;
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/40 backdrop-blur-xl saturate-180 border-b border-white/50 shadow-[0_4px_24px_rgba(0,0,0,0.04)] transition-all">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          <img
            src="/logo.png"
            alt="Payana"
            className="h-10 sm:h-11 w-auto object-contain select-none drop-shadow-xs"
          />
